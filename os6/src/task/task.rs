...
pub struct TaskControlBlockInner {
    ...
    /// LAB6
    pub opened_file_table: BTreeMap<u32, Option<Arc<OSInode>>>,
...
impl TaskControlBlock {
        ...
        let task_control_block = Self {
            ...
            inner: unsafe {
                UPSafeCell::new(TaskControlBlockInner {
                    ...
                    opened_file_table: BTreeMap::new(),
                    first_run_time: 0,
                    current_time: 0,
    ...
    pub fn fork(self: &Arc<TaskControlBlock>) -> Arc<TaskControlBlock> {
        ...
        let mut new_opened_file_table: BTreeMap<u32, Option<Arc<OSInode>>> = BTreeMap::new();
        ...
        for (fd, os_inode) in parent_inner.opened_file_table.iter() {
            if let Some(file) = os_inode {
                new_opened_file_table.insert(*fd, Some(file.clone()));
            } else {
                new_opened_file_table.insert(*fd, None);
            }
        }
        let task_control_block = Arc::new(TaskControlBlock {
            ...
            inner: unsafe {
                UPSafeCell::new(TaskControlBlockInner {
                    ...
                    opened_file_table: new_opened_file_table, 
                    first_run_time: 0,
                    current_time: 0,
                    syscall_times: [0; MAX_SYSCALL_NUM],
                    stride: max(2, BIG_STRIDE / 16),
